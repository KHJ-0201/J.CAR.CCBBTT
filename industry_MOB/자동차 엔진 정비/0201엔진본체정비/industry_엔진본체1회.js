...
const ALL_QUESTIONS = [...industry020101];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">엔진본체정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>엔진본체정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
