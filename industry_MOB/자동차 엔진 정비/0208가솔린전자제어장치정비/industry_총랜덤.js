import { industry020801 } from './industry_가솔린전자문제.js';
import { industry020802 } from './industry_가솔린전자문제.js';
import { industry020803 } from './industry_가솔린전자문제.js';
import { industry020804 } from './industry_가솔린전자문제.js';
import { industry020805 } from './industry_가솔린전자문제.js';
...
    status.innerHTML = `<span id="scoreDisplay">과급장치정비 전체랜덤 총점: ${score}/${questions.length}</span>`;
 
    // 제출 버튼 제거
...
    resultDiv.innerHTML = `<h2>과급장치정비 전체랜덤 총점: ${score}/${questions.length}</h2>`;
}
 
// -----------------------------
// 타이머
