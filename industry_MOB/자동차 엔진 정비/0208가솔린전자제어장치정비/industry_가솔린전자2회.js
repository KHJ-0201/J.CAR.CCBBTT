...
const ALL_QUESTIONS = [...industry020802];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">가솔린전자정비 2회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>가솔린전자정비 2회차 총점: ${score}/${questions.length}</h2>`;
}
