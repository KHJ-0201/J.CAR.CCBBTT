...
const ALL_QUESTIONS = [...industry020403];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">연료장치정비 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>연료장치정비 3회차 총점: ${score}/${questions.length}</h2>`;
}
