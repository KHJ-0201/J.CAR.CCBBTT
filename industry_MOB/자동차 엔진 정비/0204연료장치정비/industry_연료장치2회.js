...
const ALL_QUESTIONS = [...industry020402];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">연료장치정비 2회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>연료장치정비 2회차 총점: ${score}/${questions.length}</h2>`;
}
