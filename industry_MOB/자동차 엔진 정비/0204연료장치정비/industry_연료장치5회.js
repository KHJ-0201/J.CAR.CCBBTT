...
const ALL_QUESTIONS = [...industry020405];
...
// ✅ 문제 순서 랜덤 + 60문제 제한
let questions = shuffleArray([...industry020405]).slice(0, 60);
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">연료장치정비 5회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>연료장치정비 5회차 총점: ${score}/${questions.length}</h2>`;
}
