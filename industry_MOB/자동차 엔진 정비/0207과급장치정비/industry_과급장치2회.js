...
const ALL_QUESTIONS = [...industry020702];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">과급장치정비 2회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>과급장치정비 2회차 총점: ${score}/${questions.length}</h2>`;
}
