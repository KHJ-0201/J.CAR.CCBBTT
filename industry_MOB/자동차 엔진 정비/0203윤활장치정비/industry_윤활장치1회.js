...
const ALL_QUESTIONS = [...industry020301];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">윤활장치정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>윤활장치정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
