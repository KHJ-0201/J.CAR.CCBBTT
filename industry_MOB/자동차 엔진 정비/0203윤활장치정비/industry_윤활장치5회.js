...
const ALL_QUESTIONS = [...industry020305];
...
// ✅ 문제 순서 랜덤 + 60문제 제한
let questions = shuffleArray([...industry020305]).slice(0, 60);
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">윤활장치정비 5회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>윤활장치정비 5회차 총점: ${score}/${questions.length}</h2>`;
}
