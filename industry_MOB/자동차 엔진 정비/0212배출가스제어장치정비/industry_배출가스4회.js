...
const ALL_QUESTIONS = [...industry021204];
...
// ✅ 문제 순서 랜덤 + 60문제 제한
let questions = shuffleArray([...industry021204]).slice(0, 60);
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">배출가스정비 4회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>배출가스정비 4회차 총점: ${score}/${questions.length}</h2>`;
}
