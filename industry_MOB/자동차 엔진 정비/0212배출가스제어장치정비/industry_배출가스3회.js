...
const ALL_QUESTIONS = [...industry021203];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">배출가스정비 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>배출가스정비 3회차 총점: ${score}/${questions.length}</h2>`;
}
