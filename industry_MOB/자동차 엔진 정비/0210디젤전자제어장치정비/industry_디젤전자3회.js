...
const ALL_QUESTIONS = [...industry021003];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">디젤전자정비 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>디젤전자정비 3회차 총점: ${score}/${questions.length}</h2>`;
}
