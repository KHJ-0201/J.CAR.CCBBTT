...
const ALL_QUESTIONS = [...industry021005];
...
// ✅ 문제 순서 랜덤 + 60문제 제한
let questions = shuffleArray([...industry021005]).slice(0, 60);
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">디젤전자정비 5회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>디젤전자정비 5회차 총점: ${score}/${questions.length}</h2>`;
}
