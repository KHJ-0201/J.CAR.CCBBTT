...
const ALL_QUESTIONS = [...industry020603];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">흡배기제어장치정비 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>흡배기제어장치정비 3회차 총점: ${score}/${questions.length}</h2>`;
}
