...
const ALL_QUESTIONS = [...industry020503];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">엔진점화장치장치정비 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>엔진점화장치장치정비 3회차 총점: ${score}/${questions.length}</h2>`;
}
