...
const ALL_QUESTIONS = [...industry020203];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">냉각장치정비 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>냉각장치정비 3회차 총점: ${score}/${questions.length}</h2>`;
}
