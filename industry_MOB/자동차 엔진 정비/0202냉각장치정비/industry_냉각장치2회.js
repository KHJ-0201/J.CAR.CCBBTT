...
const ALL_QUESTIONS = [...industry020202];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">냉각장치정비 2회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>냉각장치정비 2회차 총점: ${score}/${questions.length}</h2>`;
}
