...
const ALL_QUESTIONS = [...industry030803];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">유압식현가장치정비 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>유압식현가장치정비 3회차 총점: ${score}/${questions.length}</h2>`;
}
