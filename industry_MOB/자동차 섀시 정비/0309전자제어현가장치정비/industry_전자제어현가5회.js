...
const ALL_QUESTIONS = [...industry030905];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">전자제어현가장치정비 5회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>전자제어현가장치정비 5회차 총점: ${score}/${questions.length}</h2>`;
}
