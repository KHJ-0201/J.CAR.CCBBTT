...
import { industry030302 } from './industry_자동변속문제.js';
import { industry030303 } from './industry_자동변속문제.js';
import { industry030304 } from './industry_자동변속문제.js';
import { industry030305 } from './industry_자동변속문제.js';
...
    status.innerHTML = `<span id="scoreDisplay">자동변속기정비 전체랜덤 총점: ${score}/${questions.length}</span>`;
 
    // 제출 버튼 제거
...
    resultDiv.innerHTML = `<h2>자동변속기정비 전체랜덤 총점: ${score}/${questions.length}</h2>`;
}
 
// -----------------------------
// 타이머
