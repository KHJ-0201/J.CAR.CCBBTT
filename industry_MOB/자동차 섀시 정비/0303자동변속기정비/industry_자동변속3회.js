...
const ALL_QUESTIONS = [...industry030303];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">자동변속기정비 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>자동변속기정비 3회차 총점: ${score}/${questions.length}</h2>`;
}
