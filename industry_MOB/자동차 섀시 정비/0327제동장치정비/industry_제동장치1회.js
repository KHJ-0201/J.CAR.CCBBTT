...
const ALL_QUESTIONS = [...industry032701];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">제동장치정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>제동장치정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
