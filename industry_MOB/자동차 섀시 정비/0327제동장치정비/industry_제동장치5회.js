...
const ALL_QUESTIONS = [...industry032705];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">제동장치정비 5회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>제동장치정비 5회차 총점: ${score}/${questions.length}</h2>`;
}
