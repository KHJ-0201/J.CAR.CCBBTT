...
const ALL_QUESTIONS = [...industry032602];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">조향장치정비 2회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>조향장치정비 2회차 총점: ${score}/${questions.length}</h2>`;
}
