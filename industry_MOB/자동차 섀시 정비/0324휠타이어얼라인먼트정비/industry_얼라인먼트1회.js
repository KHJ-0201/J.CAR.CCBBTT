...
const ALL_QUESTIONS = [...industry032401];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">얼라인먼트정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>얼라인먼트정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
