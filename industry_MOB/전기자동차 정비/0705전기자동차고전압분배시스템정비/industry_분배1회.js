...
const ALL_QUESTIONS = [...industry070501];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">분배정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>분배정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
