...
const ALL_QUESTIONS = [...industry070404];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">배터리정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>배터리정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
