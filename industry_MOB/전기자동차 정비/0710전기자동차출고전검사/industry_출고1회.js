...
const ALL_QUESTIONS = [...industry071001];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">출고정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>출고정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
