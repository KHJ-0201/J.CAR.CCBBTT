...
const ALL_QUESTIONS = [...industry070304];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">구성정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>구성정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
