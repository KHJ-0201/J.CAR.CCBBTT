...
const ALL_QUESTIONS = [...industry070101];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">안전정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>안전정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
