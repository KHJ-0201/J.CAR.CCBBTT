...
const ALL_QUESTIONS = [...industry070604];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">충전정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>충전정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
