...
const ALL_QUESTIONS = [...industry070902];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">열관리정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>열관리정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
