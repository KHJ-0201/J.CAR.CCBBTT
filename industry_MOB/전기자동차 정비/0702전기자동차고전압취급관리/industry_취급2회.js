...
const ALL_QUESTIONS = [...industry070202];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">취급정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>취급정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
