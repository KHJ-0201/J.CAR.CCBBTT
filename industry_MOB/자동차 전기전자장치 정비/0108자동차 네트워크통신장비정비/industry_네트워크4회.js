...
const ALL_QUESTIONS = [...industry010804];
...
// ✅ 문제 순서 랜덤 + 60문제 제한
let questions = shuffleArray([...industry010804]).slice(0, 60);
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">네트워크통신장치정비 4회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>네트워크통신장치정비 4회차 총점: ${score}/${questions.length}</h2>`;
}
