...
const ALL_QUESTIONS = [...industry010803];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">네트워크통신장치정비 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>네트워크통신장치정비 3회차 총점: ${score}/${questions.length}</h2>`;
}
