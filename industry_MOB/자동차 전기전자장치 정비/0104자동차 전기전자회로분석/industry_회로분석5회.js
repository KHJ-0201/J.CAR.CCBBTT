...
const ALL_QUESTIONS = [...industry010405];
...
// ✅ 문제 순서 랜덤 + 60문제 제한
let questions = shuffleArray([...industry010405]).slice(0, 60);
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">전기전자회로분석 5회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>전기전자회로분석 5회차 총점: ${score}/${questions.length}</h2>`;
}
