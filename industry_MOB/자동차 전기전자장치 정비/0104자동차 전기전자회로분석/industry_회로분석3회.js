...
const ALL_QUESTIONS = [...industry010403];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">전기전자회로분석 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>전기전자회로분석 3회차 총점: ${score}/${questions.length}</h2>`;
}
