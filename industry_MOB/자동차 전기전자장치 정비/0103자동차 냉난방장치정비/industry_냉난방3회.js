...
const ALL_QUESTIONS = [...industry010303];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">냉난방장치정비 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>냉난방장치정비 3회차 총점: ${score}/${questions.length}</h2>`;
}
