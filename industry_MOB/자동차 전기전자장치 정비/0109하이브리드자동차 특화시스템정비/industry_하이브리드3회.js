...
const ALL_QUESTIONS = [...industry010903];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">하이브리드자동차 3회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>하이브리드자동차 3회차 총점: ${score}/${questions.length}</h2>`;
}
