import { industry010901 } from './industry_하이브리드문제.js';
import { industry010902 } from './industry_하이브리드문제.js';
import { industry010903 } from './industry_하이브리드문제.js';
...
    status.innerHTML = `<span id="scoreDisplay">하이브리드자동차 전체랜덤 총점: ${score}/${questions.length}</span>`;
 
    // 제출 버튼 제거
...
    resultDiv.innerHTML = `<h2>하이브리드자동차 전체랜덤 총점: ${score}/${questions.length}</h2>`;
}
 
// -----------------------------
// 타이머
