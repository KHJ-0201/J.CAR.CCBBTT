import { industry010905 } from './industry_하이브리드문제.js';

const ALL_QUESTIONS = [...industry010905];
...
// ✅ 문제 순서 랜덤 + 60문제 제한
let questions = shuffleArray([...industry010905]).slice(0, 60);
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">하이브리드자동차 5회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>하이브리드자동차 5회차 총점: ${score}/${questions.length}</h2>`;
}
