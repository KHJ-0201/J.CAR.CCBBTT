...
const ALL_QUESTIONS = [...industry010501];
...
function submitQuiz() {
    ...
    status.innerHTML = `<span id="scoreDisplay">편의장치정비 1회차 총점: ${score}/${questions.length}</span>`;
    ...
    resultDiv.innerHTML = `<h2>편의장치정비 1회차 총점: ${score}/${questions.length}</h2>`;
}
