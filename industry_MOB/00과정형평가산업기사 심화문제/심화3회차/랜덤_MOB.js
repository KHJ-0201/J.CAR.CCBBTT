/* ===========================
    1. 데이터 임포트 (심화3회차만 사용)
=========================== */
import * as Data1 from './심화3회차.js';

// 기존 6개 그룹 변수는 제거하거나 심화3회차만 할당
let questions = [];
let answers = [];
...
=========================== */
function initApp() {
    // Data1(심화3회차.js)의 repairData에서 모든 문제를 가져옴 (회차 정보 고정)
    if (Data1.repairData && Array.isArray(Data1.repairData)) {
        // 심화3회차 데이터 전체를 가져오되, roundInfo를 "심화3회차"로 설정
