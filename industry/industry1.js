...
export const industry1Questions = [
    ...
    {
        question: "팽창 밸브(TXV)의 정상 작동 여부를 판단하기 위해 팽창 밸브 출구 측 냉매 파이프를 점검했을 때, 냉방 작동 중 밸브 출구에서 서리가 심하게 발생하는 현상이 나타났습니다. 이 경우 의심되는 팽창 밸브의 고장 상태는 무엇입니까?",
        options: ["팽창 밸브의 감온통이 냉매 파이프에서 탈착된 경우", "팽창 밸브의 오리피스가 과도하게 열린 경우", "팽창 밸브의 오리피스가 부분적으로 막힌 경우", "팽창 밸브 내부의 냉매가 과열된 경우"],
        answer: 2,
        explain: "팽창 밸브가 부분적으로 막히면 냉매가 미세한 구멍을 지나면서 과도하게 팽창하여 출구에서만 온도가 급격히 하강하며 서리가 발생하는 현상이 나타납니다."
    },
    {
        question: "난방 장치 작동 시 'Max Heat' 모드(최대 난방)를 설정했음에도 불구하고 찬 바람이 토출됩니다. A/C 시스템은 꺼져 있고, 블로워 모터는 정상 작동하는 경우, 가장 먼저 점검해야 할 것은 무엇입니까?",
        options: ["냉각수 온도 게이지와 냉각수 레벨", "A/C 압축기 클러치", "증발기 온도 센서", "냉매 고압/저압 압력"],
        answer: 0,
        explain: "난방은 엔진 냉각수의 열을 이용하므로, 찬 바람이 나오는 경우 냉각수 부족이나 엔진 과냉각(서모스탯 고장)을 의심하고 냉각수 온도와 레벨을 점검해야 합니다."
    }
];
