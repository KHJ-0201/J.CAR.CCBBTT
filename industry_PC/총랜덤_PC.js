import { industry010301, industry010302, industry010303, industry010304, industry010305 } from './자동차 전기전자장치 정비_PC/0103자동차 냉난방장치정비/industry_냉난방문제.js';
import { industry010401, industry010402, industry010403, industry010404, industry010405 } from './자동차 전기전자장치 정비_PC/0104자동차 전기전자회로분석/industry_회로분석문제.js';
import { industry010501, industry010502, industry010503, industry010504, industry010505 } from './자동차 전기전자장치 정비_PC/0105자동차 편의장치 정비/industry_편의장치문제.js';
import { industry010701, industry010702, industry010703, industry010704, industry010705 } from './자동차 전기전자장치 정비_PC/0107자동차 주행안전장치정비/industry_주행안전문제.js';
import { industry010801, industry010802, industry010803, industry010804, industry010805 } from './자동차 전기전자장치 정비_PC/0108자동차 네트워크통신장비정비/industry_네트워크문제.js';
import { industry010901, industry010902, industry010903, industry010904, industry010905 } from './자동차 전기전자장치 정비_PC/0109하이브리드자동차 특화시스템정비/industry_하이브리드문제.js';
import { industry020101, industry020102, industry020103, industry020104, industry020105 } from './자동차 엔진 정비_PC/0201엔진본체정비/industry_엔진본체문제.js';
import { industry020201, industry020202, industry020203, industry020204, industry020205 } from './자동차 엔진 정비_PC/0202냉각장치정비/industry_냉각장치문제.js';
import { industry020301, industry020302, industry020303, industry020304, industry020305 } from './자동차 엔진 정비_PC/0203윤활장치정비/industry_윤활장치문제.js';
import { industry020401, industry020402, industry020403, industry020404, industry020405 } from './자동차 엔진 정비_PC/0204연료장치정비/industry_연료장치문제.js';
import { industry020501, industry020502, industry020503, industry020504, industry020505 } from './자동차 엔진 정비_PC/0205엔진점화장치정비/industry_엔진점화장치문제.js';
import { industry020601, industry020602, industry020603, industry020604, industry020605 } from './자동차 엔진 정비_PC/0206흡배기제어장치정비/industry_흡배기제어장치문제.js';
import { industry020701, industry020702, industry020703, industry020704, industry020705 } from './자동차 엔진 정비_PC/0207과급장치정비/industry_과급장치문제.js';
import { industry020801, industry020802, industry020803, industry020804, industry020805 } from './자동차 엔진 정비_PC/0208가솔린전자제어장치정비/industry_가솔린전자문제.js';
import { industry021001, industry021002, industry021003, industry021004, industry021005 } from './자동차 엔진 정비_PC/0210디젤전자제어장치정비/industry_디젤전자문제.js';
import { industry021201, industry021202, industry021203, industry021204, industry021205 } from './자동차 엔진 정비_PC/0212배출가스제어장치정비/industry_배출가스문제.js';
import { industry030301, industry030302, industry030303, industry030304, industry030305 } from './자동차 섀시 정비_PC/0303자동변속기정비/industry_자동변속문제.js';
import { industry030801, industry030802, industry030803, industry030804, industry030805 } from './자동차 섀시 정비_PC/0308유압식현가장치정비/industry_유압식현가문제.js';
import { industry030901, industry030902, industry030903, industry030904, industry030905 } from './자동차 섀시 정비_PC/0309전자제어현가장치정비/industry_전자제어현가문제.js';
import { industry032401, industry032402, industry032403, industry032404, industry032405 } from './자동차 섀시 정비_PC/0324휠타이어얼라인먼트정비/industry_얼라인먼트문제.js';
import { industry032601, industry032602, industry032603, industry032604, industry032605 } from './자동차 섀시 정비_PC/0326조향장치정비/industry_조향장치문제.js';
import { industry032701, industry032702, industry032703, industry032704, industry032705 } from './자동차 섀시 정비_PC/0327제동장치정비/industry_제동장치문제.js';
import { industry032801, industry032802, industry032803, industry032804, industry032805 } from './자동차 섀시 정비_PC/0328주행안전보조시스템정비/industry_주행안전문제.js';
...
function resetQuiz() {
    ...
    status.innerHTML = `
        <h1 class="page-title">전기전자+엔진+섀시 전체랜덤</h1> 
        <div class="status-info">
            <span id="timer">남은 시간: 01:40:00</span>
...
    let s = totalSeconds % 60;
    ...
    if (h > 0) {
        document.getElementById("timer").textContent = `남은 시간: ${h.toString().padStart(2, "0")}:${m.toString().padStart(2, "0")}:${s.toString().padStart(2, "0")}`;
    }
    else {
        document.getElementById("timer").textContent = `남은 시간: ${h.toString().padStart(2, "0")}:${m.toString().padStart(2, "0")}:${s.toString().padStart(2, "0")}`;
    }
